window.onload = function() {
    ...
    ajaxXHR('GET', 'technicalblog.json', function(data) {
        var blog = data.blog;
        var str = '';
        str += '<div class="blog"><span>博客园:</span><span>' + blog.Technicalblog + '</span></div>'
        document.getElementById("link").insertAdjacentHTML('beforeend', str);
    })
